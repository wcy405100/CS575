...
const char *WINDOWTITLE = { "OpenCL/OpenGL Particle System -- Chenyu" };
...
const char *CL_FILE_NAME   = { "chenyu.cl" };
const char *CL_BINARY_NAME = { "chenyu.nv" };
...
{
	fprintf(stderr,"The local size is %3d. The number of particle is %3dM.\n", LOCAL_SIZE,NUM_PARTICLES/1024/1024);
	glutInit( &argc, argv );
	InitGraphics( );
	InitLists( );
	InitCL( );
